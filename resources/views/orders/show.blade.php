                ...
                <div class="card-body">
                    ...
                    <div class="order-bottom">
                        <div class="order-info">
                            ...
                            @if ($order->paid_at && $order->refund !== App\Models\Order::REFUND_STATUS_PENDING)
                                <div class="line">
                                    <div class="line-label">退款状态：</div>
                                    <div class="line-value">{{ \App\Models\Order::$refundStatusMap[$order->refund_status] }}
                                    </div>
                                </div>
                                <div class="line">
                        ...
                        <div class="order-summary text-right">
                            ...
                            <div>
                                ...
                                @if ($order->ship_status === \App\Models\Order::SHIP_STATUS_DELIVERED)
                                    <button type="button" class="btn btn-sm btn-success" id="btn-success">确认收货</button>
                            </div>
                            @endif
                            <!-- 支付按钮结束 -->
                            <!-- 订单已支付，且退款状态是未退款时展示申请退款按钮 -->
                            @if ($order->type!==App\Models\Order::TYPE_CROWDFUNFING &&
                                                $order->paid_at &&
        ...
        $(document).ready(function() {
            ...
            $('#btn-success').click(function() {
                swal({
                    ...
                    axios.post('{{ route('orders.received', ['order' => $order->id]) }}').then(res => {
                        location.reload();
                    })
                })
            })
